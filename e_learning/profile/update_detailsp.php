...
$updates=mysqli_query($con,"UPDATE education SET University_id='$University_id',PrimarySchool='$PrimarySchool',EducationLevel_id='$Education_id',SecondarySchool='$SecondarySchool',Certifications='$Certifications' Where user_id='$user_id'") or die(mysqli_error($con));
}else{
