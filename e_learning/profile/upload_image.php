...
//$fullname=mysqli_real_escape_string($con,"userelearner".$id."_".$first_name."_".$last_name."_".$dated);
$fullnamed=mysqli_real_escape_string($con,"userelearner".$id."_".$first_name."_".$last_name);
...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
{
       if(isset($_FILES['upfile']['name'])){
		...
		//	@unlink('../../../../'.$OldprofilePic.'');
			 ...
			 @unlink("../../Huduma_WhiteBox/images/innovators/".$new_names);
			 @move_uploaded_file($pictmp,"../../Huduma_WhiteBox/images/innovators/".$_FILES['upfile']['name']);
	 		  rename("../../Huduma_WhiteBox/images/innovators/".$_FILES['upfile']['name'],"../../Huduma_WhiteBox/images/innovators/".$fullnamed.".png");
