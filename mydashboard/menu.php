...
<div class="col-xs-12 col-sm-12 buton_navesd" role="curriculum"><i class="fa fa-list"></i> Modules</div>
<div class="col-xs-12 col-sm-12 buton_navesd" role="tests"><i class="fa fa-line-chart"></i> My scores</div>
<div class="col-xs-12 col-sm-12 buton_navesd" role="chats"><i class="fa fa-comments"></i> Chats</div>
<div class="col-xs-12 col-sm-12 buton_navesd" role="calender"><i class="fa fa-calendar"></i> Events Calendar</div>
<div class="col-xs-12 col-sm-12 buton_navesd" role="profile"><i class="fa fa-user"></i> My Profile</div>
