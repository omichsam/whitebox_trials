 ...
 */
$(".notificationbtnbn").click(function(){
  var my_id=$("#user_email").val();
...
var my_id=$("#user_email").val();
      $.post("modules/system/external/control/refresh.php",{my_id:my_id},function(data){$(".notyholderpbk").html(data)}); 
...
<li>
<a class="menu_dtz btn notificationbtnbn" id="" ><i class="fa fa-bell bell_hides no-radius"></i><i class="notyholderpbk"></i></a> 
</li>
...
-->
 <a class="navbar-brand "><img src="Huduma_WhiteBox/m.png" alt="logo" class="logo_position"> </a></li>
<!-- The Modal -->
 ...
 <section id="menu_page" class="desktop_hidden"   style="min-height: 100%; max-height: 100%; overflow: auto;background: #222d32;">
    ...
    <section class="content no_padding dashboard_holder">
        ...
        <div class="row no_padding">
        	...
        	<div class="col-sm-10 col-xs-12" id="learning_area" style="min-height:630px;max-height: 530px;overflow: auto;box-shadow: 0 0 2px #ccc;background: #fff;"></div>
        </div>
    </section>
