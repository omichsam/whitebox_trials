 ...
 <span class="btn " id="open_pres" style="color:green;cursor:pointer;" > <i class="fa fa-comment fa-2x"></i></span>
  ...
  <div class="container">
        <div class="row">
            ...
            <h3 class="border-primary text-center"><span class="heading_border bg-primary">Communication area</span></h3>
            <div class="col-md-6" id="contact-form">
                <h2>Contact Whitebox Team</h2>
                <!-- Notifications -->
                
                <form class="contact" id="contact_form" action="login/contact_form.php" method="POST">
                    <div class="form-group">
                        <input type="text" name="contactname" id="contactsname" class="form-control foms_contri input-lg" placeholder="Your name" required="">
                    </div>
                    <div class="form-group">
                        <input type="email" name="contactemail" id="contacts_emails" class="form-control foms_contri input-lg" placeholder="Your email address" required="">
                    </div>
                    <div class="form-group">
                        <textarea name="contactmsg" id="contacts_message" class="form-control foms_contri input-lg no-resize resize_vertical" rows="6" placeholder="Your Message" required=""></textarea>
                    </div>
                    <div class="input-group">
                        <span class="btn btn-primary" id="contact_submits">Submit</span>
                        <button class="btn btn-danger" type="reset">Reset</button>
                    </div>
                    <div class="col-md-12 " style="text-align: center;" id='contacts_loader'></div>
                </form>
            </div>
            ...
            <div class="col-md-6 col-sm-6" id="address_margt">
                ...
                <div class="media media-right">
                    <div class="media-left media-top">
                       <!--  <a href="#">
                           <div class="box-icon">
                                <i class="fa fa-home" style="width: 22px; height: 22px;"></i>
                            </div> </a>-->

                                <i class="fa fa-home fa-2x" style="width: 22px; height: 22px;"></i>
                        
                    </div>
                    <div class="media-body">
                        <h4 class="media-heading">Address:</h4>
                        <div class="danger">ICT Authority</div>
                        <address>
                            Teleposta Towers, 12th Flr,

                            <br> Kenyatta Ave., Nairobi, Kenya.
                            <br>P.O. Box 27150 - 00100,
                            <br> Nairobi, Kenya.
                        </address>
                    </div>
                </div>
                <div class="media padleft10">
                    <div class="media-left media-top">
                       <!-- <a href="#">
                            <div class="box-icon">
                                <i class="fa fa-phone " style="width: 22px; height: 22px;"></i>
                            </div>
                        </a>-->
                          <i class="fa fa-phone fa-2x" style="width: 22px; height: 22px;"></i>
                    </div>
                    <div class="media-body padbtm2">
                        <h4 class="media-heading">Telephone:</h4> +254 20 2211960
                        <br> +254 20 2211961
                    </div>
                </div>
            </div>
