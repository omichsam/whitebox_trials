...
$First_namd=$get['First_name'];
$Last_namd=$get['Last_name'];

if($First_namd && $Last_namd){
$First_name=base64_decode(decrypt($First_namd,$key));
$Last_name=base64_decode(decrypt($Last_namd,$key));
...
<div class="col-sm-10 col-xs-8 ">
	...
	<div class="col-sm-10  mobile_hidden no_padding heade_app">HERIHUB INNOVATION PORTAL</div>
	<div class="col-sm-12 col-xs-12 desktop_hidden no_padding heade_app">INNOVATION PORTAL</div>
	
</div>

<div class="col-sm-1 col-xs-2"><i class="desktop_hidden"><?php echo $First_name ?></i></div>
	<div class="col-sm-1 col-xs-2 "><i class="mobile_hidden"><?php echo $Last_name ?></i><i class=" fa fa-bars desktop_hidden btn header_baers" ></i>
</div>
</div>
</div>
