...
$User_id=$get['id'];
//echo $User_id;
$sqlx="SELECT * FROM chartbot where status='general'";
    ...
    while($row=mysqli_fetch_array($query_runx)){
     ...
     $get_mesage=mysqli_query($con,"SELECT id FROM chat_reads WHERE message_id='$message_id' and     user_id='$User_id'") or die(mysqli_error($con));
     ...
     <script type="text/javascript">
         $(document).ready(function(){
              ...
              if(notificationshow=="not_shown"){
                $(".notificationbtnbn").hide();
              }else{
              $(".notificationbtnbn").show();
              }
  })
