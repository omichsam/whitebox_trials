...
<div class="col-sm-12 col-xs-12">
  ...
  <div class="col-sm-12 col-xs-12" id="feedback_body">
...
$checkquestions=mysql_query("SELECT * FROM feedback WHERE Innovation_id='$Innovation_Id'") or die(mysql_error());
...
<div class="col-sm-1  col-xs-1"><?php echo $counter?></div>
  <div class="col-xs-3 col-sm-7 mobile_hidden overflow_data" style="text-align:left"><?php echo $Innovation_name?> </div>

  <div class="col-sm-2 mobile_hidden no_padding col-xs-2"><?php echo $time_d?> </div>
   
  <div class="col-sm-2 col-xs-1"><span id="<?php echo $Innovation_Id ?>" class="view_feedback "><i class="fa fa-eye "></i><span class="mobile_hidden"> View Feedback</span></span>  </div>
</div>
...
<?php
    ...
    ?>
    <div class="col-sm-12 col-xs-12" style="text-align:center">No Feedback recieved yet</div>
    <?php
}
...
var feedback=".view_feedback";
var home_target="#home";
$(feedback).click(function(){
var my_id=$("#global_u_email").val();
  var innovation=$(this).attr("id");
  //alert(innovation);
var url="modules/system/external/pages/feedback/feedback_view.php";
$.post(url,{innovation:innovation,
my_id:my_id},function(data){$(home_target).html(data)});
})
  })
</script>
