...
$sqlx="SELECT * FROM notifications where user_id='$User_id' order by date_added DESC";
$counter=0;
...
$(".span_loaders").click(function(){
    ...
    $.post("modules/system/external/pages/notifications/view.php",{notificationid:notificationid})
})
  })
</script>