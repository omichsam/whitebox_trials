...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
  ...
  <div class="col-sm-1 col-xs-1"><strong><span id="<?php echo $usersid ?>" class=" veiw_evaluatet "><i class="fa fa-undo "></i><span class="mobile_hidden"> Retrieve</span></span> </strong></div>
...
var view_evaluate=".veiw_evaluatet";
var target="#home";
