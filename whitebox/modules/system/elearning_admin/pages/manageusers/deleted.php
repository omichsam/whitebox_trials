...
<div class="col-sm-12 col-xs-12" id="header_innovation"><h4 id="filter_headers"> <span style="float:left;margin-bottom: 2px;" id="view_all" class="btn btn-danger">Back to registered</span>DELETED LEARNERS</h4></div> 
...
$next_page=$pageno+1;
 $no_of_records_per_page = 10;
       ...
       $allcounter=0; 
      $sqlx="SELECT * FROM e_learning_users WHERE status='deleted'";
...
$sqlx="SELECT * FROM e_learning_users WHERE status='deleted' LIMIT $offset,$no_of_records_per_page";
...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
  ...
  <div class="col-sm-1 col-xs-1"><strong><span id="<?php echo $usersid ?>" class=" veiw_evaluate "><i class="fa fa-undo "></i><span class="mobile_hidden"> Retrieve</span></span> </strong></div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/elearning_admin/pages/manageusers/deletedmore.php",{
            offset:offset
        },function(data){
...
$(view_evaluate).click(function(){
  ...
  var txt;
  var r = confirm("Are you sure you wish to retrieve this user deteted user?, click OK to proceed or CANCEL to stop?");
  if (r == true) {
var url="modules/system/elearning_admin/pages/manageusers/retrieve.php";
