...
<script>
 ...
 $(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
   ...
   $.ajax({
    url:"modules/system/elearning_admin/pages/datapage/upload.php",
    method:"POST",
  ...
  function start_import()
  {
   ...
   $.ajax({
    url:"modules/system/elearning_admin/pages/datapage/import.php",
    success:function()
    {
  ...
  function get_import_data()
  {
   ...
   $.post("modules/system/elearning_admin/pages/datapage/process.php",{doc_id:doc_id},function(data){
