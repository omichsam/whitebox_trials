...
$sqlx="SELECT * FROM e_learning_admin where Id='$users'";
$counter=0;
...
$sqlx="SELECT * FROM analytics_elearnes_admin where User_id='$user_id'";
$counter=0;
    $query_runx=mysqli_query($con,$sqlx) or die($query_runx."<br/><br/>".mysqli_error($con));
...
var User_id=btoa('<?php echo $user_id?>');
 $.post("modules/system/elearning_admin/pages/Dashboard/edit_page.php",{User_id:User_id},function(data){
  $("#hide_previous").hide();
...
var User_id='<?php echo $users?>';
 ...
 $.post("modules/system/elearning_admin/pages/Dashboard/deactivate.php",{User_id:User_id},function(data){
...
var User_id='<?php echo $users?>';
 //var users=btoa($(this).attr("id"));
 $.post("modules/system/elearning_admin/pages/Dashboard/activate.php",{User_id:User_id},function(data){
    if($.trim(data)=="success"){
    ...
    $("#error_reporters").html("");   
        ...
        $("#error_reporters").html(loader)
        $.get("modules/system/elearning_admin/pages/view/view.php",function(data){
          $("#home").html(data);
          $("#error_reporters").html("")
        })
      }
