...
//echo $my_pass;
$update=mysqli_query($con,"UPDATE e_learning_admin SET Name='$new_name',Admin_role='$account',phone='$phone',user_name='$email' WHERE Id='$user'") or die(mysqli_error($con));
echo 'success';
}else{
