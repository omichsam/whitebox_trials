...
$sqlx="SELECT * FROM e_learning_admin where Id='$User_id'";
$counter=0;
...
<div class="col-sm-12 col-xs-12">
    ...
    <option><?php echo $old_category?></option>
		<option class="<?php echo $clerk?>">Content team</option>
		<option class="<?php echo $communications?>">Communications</option>
	<option class="<?php echo $elearning_admin?>">Super admin</option>
...
$(".bulk_btns").click(function(){
        ...
        if(first_name && last_name && email && account_value && phone){
          ...
          $.post("modules/system/elearning_admin/pages/Dashboard/add_edit.php",{
