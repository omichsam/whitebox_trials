...
<div class="col-sm-12 col-xs-12" id="filtered_datadv">

</div>
</div>
<script type="text/javascript">
  $(document).ready(function(){
     $.get("modules/system/elearning_admin/pages/Dashboard/view_all.php",function(data){$("#filtered_datadv").html(data)})
...
$("#filter_headers").html(header_data);
  $("#filtered_datadv").html(loader)
$.post("modules/system/elearning_admin/pages/view/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
$("#filtered_datadv").html(data)
})
}
...
var url="modules/system/elearning_admin/pages/evaluate/evaluate.php";
$.post(url,{innovation:innovation},function(data){$(target).html(data)});
})
$("#add_user").click(function(){
$.get("modules/system/elearning_admin/pages/view/add_user.php",function(data){
  $("#home").html(data);
})
