...
<div class="col-sm-2 col-xs-12">
	...
	?>
		...
		<!--<span class="btn theme_bg">raw data</span>--> <span class="btn theme_bg" id="Graphpage">Graph</span></div>.
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#Graphpage").click(function(){
			...
			$.post('modules/system/callcenter/datapage/graph.php',{dataid:dataid,grapghtype:grapghtype},function(data){
				$("#home").html(data);
