...
<div class="col-sm-12 col-xs-12">
	<div class="col-sm-12 col-xs-12 default_header" style="border-bottom:2px solid #000">Online chats</div>

<?php


include("../../../../../connect.php");
$sqlx="SELECT * FROM chat_users where status='active'";
...
<div class="col-sm-4 col-xs-12">
	<div class="col-sm-12 col-xs-12  chart_kubwa">
		<div class="col-sm-12 col-xs-12 charts_kichwa">
		<div class="led-box">
     <div class="led-green"></div>
  </div>	<?php echo $fname." ".$sname;?><span class="take_over btn theme_bg" style="float:right" id="<?php echo $chart_id?>">Chat</span>
...
$chechactiveness="";
  ...
  $sqlxp="SELECT * FROM chartbot WHERE chat_id ='$chart_id' or Status='general'";
    $query_runxo=mysqli_query($con,$sqlxp) or die($query_runxo."<br/><br/>".mysqli_error($con));

    while($row=mysqli_fetch_array($query_runxo)){
