...
<H3> This function awaits directions from the whitebox team on how to handle successiful innovations</H3>
<H5>Thank You</H5>
<!--<style type="text/css">
  .assingn_innovations{
  }
...
<div class=" col-sm-12 col-xs-12 no_padding">
  ...
  <div class="col-sm-2 col-xs-1 mobile_hidden" > COMPANY </div>
   <div class="col-xs-2 col-sm-2 mobile_hidden content_h" >LOCATION</div>
...
?>
 ...
 <div class="col-xs-4 col-sm-2  content_h" ><?php echo $counter.". ".$Name?></div>
  <div class="col-sm-2 col-xs-2 mobile_hidden" > <?php echo $Company?> </div>
   <div class="col-xs-2 col-sm-2 mobile_hidden" ><?php echo $Location?></div>
