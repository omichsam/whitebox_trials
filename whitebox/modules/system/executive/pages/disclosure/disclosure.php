...
<div class="col-sm-12 col-xs-12">
 <div class=" col-sm-12 col-xs-12 no_padding">
  <div class="col-sm-12 col-xs-12 default_header">INVESTORS/IMPLEMENTERS/PARTNERS APPROVED FOR THE NON-DISCLOSURE AGREEMENT</div>
...
<script>
    $(document).ready(function(){
        $(".open_disclosure").click(function(){
            ...
            //alert(user)
            $.post("modules/system/executive/pages/disclosure/view.php",{user:user},function(data){
                $("#home").html(data);
            })
        })
    })
