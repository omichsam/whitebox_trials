...
$sqlxo="SELECT requirements FROM innovations_information where Innovation_Id='$innovation'";
$counter=0;
...
<div class="col-sm-12 col-xs-12 evaluate_header" id="">EVALUATION STAGE FIVE</div>
<div class="col-sm-12 col-xs-12 no_padding">
<div class="col-sm-8 col-xs-12 ">
  ...
  <div class="col-sm-12 colxs-12 default_header">BUSINESS REQUIREMENTS</div>
...
<textarea id="comment_requirements" onkeyup="requirementsdupdate(this.value)" class="coments col-sm-12 col-xs-12"></textarea>
<div class="colsm-12 col-xs-12" style="text-align: center; " id="requirements_check"></div>
</div>
...
<div class="col-sm-4 col-xs-12 "><span class="btn evaluate_requirement theme_bg" role="back">Back</span> <!--<span class="btn evaluate_requirement theme_bg">Disapprove</span>--> <span class="btn evaluate_requirement theme_bg" role="fifth_page">Next Step</span> </div>
...
<script type="text/javascript">
  ...
  var lng = str.length;
  document.getElementById("requirements_check").innerHTML = lng + ' out of 400 characters';
}
  $(document).ready(function(){
    var loader=$("#loader").html()
    var display="#fifth_error";
    var sixth_target="#sixth_page";
    ...
    var urlsix="modules/system/clerk/pages/evaluate/sixth_page.php";
    $(".evaluate_requirement").click(function(){
      var user=$("#user_email").val();
      var my_role=$(this).attr("role");
      if(my_role=="fifth_page"){
        var comment_requirements=$("#comment_requirements").val()
        if(comment_requirements){
          
 var field=btoa("requirements_feedback");
    var innovats='<?php echo $innovation?>';
    var innovation=btoa(innovats);
        var coments=btoa(comment_requirements);
...
//alert()
      $("#requirements_check").html("Say something here").css("color","red");
}
