...
$sqlxo="SELECT businessmodel_feedback,Clerk_id FROM feedback where Innovation_id='$innovation' and status='$status'";
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/executive/pages/evaluate/sixth_page.php";
