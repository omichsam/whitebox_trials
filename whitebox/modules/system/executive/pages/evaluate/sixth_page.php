...
$sqlxo="SELECT requirements_feedback,Clerk_id FROM feedback where Innovation_id='$innovation' and status='$status'";
...
<div class="col-sm-12 col-xs-12 no_padding">
 ...
 <div class="col-sm-12 col-xs-12" id="innovationneed">
<?php echo $newrequirements_feedback?>
</div>
</div>
<!--<div class="col-sm-12 col-xs-12">
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/executive/pages/evaluate/last_page.php";
