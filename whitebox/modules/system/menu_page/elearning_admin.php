...
<div class="col-sm-12 col-xs-12 controls_holders no_padding">
	...
	<div class=" nmk_controls   col-xs-12 col-sm-12"   role="view"><i class="fa fa-users"></i> Manage Users</div>
   <!-- <div class=" nmk_controls    col-xs-12 col-sm-12"   role="reports"><i class="fa fa-file"></i> Write reports</div>-->
