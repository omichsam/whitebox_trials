...
$get_user=mysqli_query($con,"SELECT user_name,Name,Admin_role FROM e_learning_admin WHERE user_name='$user'") or die(mysqli_error($con));
...
<section class="footer">WhiteBox e-learning Portal</section>
