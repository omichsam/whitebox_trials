...
<div class="col-xs-12 col-sm-12 buton_naves" role="analytics"><i class="fa fa-list"></i> Materials</div>
<div class="col-xs-12 col-sm-12 buton_naves" role="manage"><i class="fa fa-graph"></i> My scores</div>
<div class="col-xs-12 col-sm-12 buton_naves" role="curriculum"><i class="fa fa-message"></i> Curriculum</div>
<div class="col-xs-12 col-sm-12 buton_naves" role="members"><i class="fa fa-message"></i> Notifications</div>
