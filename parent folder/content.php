...
$query_runx=mysqli_query($con,$sqlx) or die($query_runx."<br/><br/>".mysqli_error($con));
 ...
 ?>
        ...
        <section class="purchas-main ">
            <div class="container  bg-border wow pulse" data-wow-duration="2.5s" style="visibility: visible; animation-duration: 2.5s;">
                <div class="row ">
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <h1 class="purchae-hed">Patents that you can use to innovate</h1></div>
                    <div class="col-md-5 col-sm-5 col-xs-12"><a href="http://www.kipi.go.ke/index.php/big-4-agenda" target="_blank" class="btn-sm btn-primary purchase-styl pull-right">Read more</a></div>
                </div>
            </div>
        </section>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-6 col-md-3 wow bounceInLeft" data-wow-duration=".5s" style="visibility: hidden; animation-duration: 0.5s; animation-name: none;">
                <div class="box" style="background-color: #204565">
                    <div class="box-icon">
                        <i class="livicon icon" data-name="users" data-size="55" data-loop="true" data-c="#BC0000" data-hc="#000000" id="livicon-11" style="width: 55px; height: 55px;"></i>
                    </div>
                    <div class="info" style="color: #ffffff">
                        <h3 class="primary text-center" style="color: #ffffff">Registered Users</h3>
                         <div class="count text-center" id="shiva" style="font-weight: 600;  color: #ffffff; margin: -8px;"><?php echo $innovators?></div>
                    </div>
                </div>
            </div>
             <div class="col-sm-6 col-md-6 wow bounceInLeft" data-wow-duration=".5s" style="visibility: hidden; animation-duration: 0.5s; animation-name: none;">
                <div class="box" style="background-color: #204565">
                    <div class="box-icon">
                        <i class="livicon icon" data-name="clock" data-size="55" data-loop="true" data-c="#6d9e42" data-hc="#BC0000" id="livicon-12" style="width: 55px; height: 55px;"></i>
                    </div>
                    <div class="info" style="color: #ffffff">
                        ...
                        <div class="row" style="font-weight: bold;font-size: 15px;">
                            <div class="col-md-2 col-sm-6 col-xs-6 text-center" >
                                <div class="count " id="shiva" style="font-weight: 600; color: #ffffff; margin: -30px;"><?php echo $Housing?></div>
                                <label style="color: #ffffff;">Housing</label>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-6 text-center">
                                <div class="count " id="shiva" style="font-weight: 600; color: #ffffff; margin: -30px;"><?php echo $Manufacturing?></div>
                                <label style="color: #ffffff;">Manufacturing</label>
                            </div>
                            <div class="col-md-2  col-sm-6 col-xs-6 text-center">
                                <div class="count " id="shiva" style="font-weight: 600; color: #ffffff; margin: -30px;"><?php echo $Healthcare?></div>
                                <label style="color: #ffffff;">Health</label>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-6 text-center">
                                <div class="count " id="shiva" style="font-weight: 600; color: #ffffff; margin: -30px;"><?php echo $Food_Security?></div>
                                <label style="color: #ffffff;">Food Security</label>
                            </div>
                            <div class="col-md-2 col-sm-6 col-xs-6 text-center">

                                <div class="count " id="shiva" style="font-weight: 600; color: #ffffff; margin: -30px;"><?php echo $others?></div>
                                <label style="color: #ffffff;">Others</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-md-3 wow bounceInLeft" data-wow-duration=".5s" style="visibility: hidden; animation-duration: 0.5s; animation-name: none;">
                <div class="box" style="background-color: #204565">
                    <div class="box-icon">
                        <i class="livicon icon" data-name="rocket" data-size="55" data-loop="true" data-c="#f89a14" data-hc="#4F65B3" id="livicon-13" style="width: 55px; height: 55px;"></i>
                    </div>
                    <div class="info" style="color: #ffffff">
                        <h3 class="primary text-center" style="color: #ffffff">Submitted Innovations</h3>
                        <div class="count text-center" id="shiva" style="font-weight: 600;  color: #ffffff; margin: -8px;"><?php echo $innovations?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="main-timeline">
                <div class="timeline">
                    <div class="timeline-content">
                        ...
                        <div class="content">
                            <span class="year"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tell us who you are</font></font></span>
                            <h4 class="title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Stage 1</font></font></h4>
                            <p class="description"><font></font>
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        ...
                        <div class="content">
                            ...
                            <p class="description"><font></font>
                                Your innovation will be evaluated to determine its viability and the support required<br>
                                Priority will be given to products that focus on the BIG 4 Agenda.<font></font>
                            </p>
                            <div class="icon"><span></span></div>
                        </div>
                    </div>
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        ...
                        <div class="content">
                            ...
                            <p class="description"><font></font>
                               Viable innovations will be considered for further support to be developed into product, service.<font></font>
                            </p>
                            <div class="icon"><span></span></div>
                        </div>
                    </div>
...
procurement law.<font></font>
    ...
    <div class="container-fluid home_pages">
        ...
        <div class="text-center" id="facility">
            <h3 class=" border-primary text-center"><span class="heading_border bg-primary">Huduma WhiteBox Services </span></h3>
        </div>
        <section class="purchas-main" style="background-color: #418BCA
         ; color: #fff;">
            <div class="container bg-border wow pulse" data-wow-duration="1.0s" style="background-color: rgb(65, 139, 202); color: rgb(255, 255, 255); visibility: hidden; animation-duration: 1s; animation-name: none;">
    ...
    <!--  
        ...
        <div class="col-md-4 wow bounceInLeft" data-wow-duration=".3s" style="visibility: hidden; animation-duration: 0.3s; animation-name: none;">
        ...
        <div class="col-md-4 wow bounceInLeft" data-wow-duration=".3s" style="visibility: hidden; animation-duration: 0.3s; animation-name: none;">
            <div class="author" style="height: 180px;">
               ...
               ;">Technical Assistance</h4>
                <span> Access to expert guidance from a network of industry, legal, management and finance experts to provide guidance on
        ...
        <div class="col-md-4 wow bounceInLeft" data-wow-duration=".3s" style="visibility: hidden; animation-duration: 0.3s; animation-name: none;">
            <div class="author" style="height: 180px;">
                <img src="Huduma_WhiteBox/financial.png" alt="Financial Support" class="img-responsive img-circle pull-left">
