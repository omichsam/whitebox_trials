...
<div id="menu" class=" no_padding col-sm-12 col-xs-12 ">
 ...
 <div class="col-xs-12 col-sm-12 no_padding menu_kkdives" id="superadmin_divd">
  ...
  <div class=" nmk_controlsds nmk_adminsd col-xs-12 col-sm-12"   role="view"><i class="fa fa-users"></i> Manage Admin Users</div>
  <div class=" nmk_controlsds nmk_adminsd col-xs-12 col-sm-12"   role="innovator"><i class="fa fa-users"></i> Manage innovators</div>
  
  <div class=" nmk_controlsds nmk_adminsd col-xs-12 col-sm-12"   role="manage_settings"><i class="fa fa-gears"></i> Settings</div>
  ...
  <div class=" nmk_controlsds nmk_adminsd  col-xs-12 col-sm-12"   role="viable_innovations"><i class="fa fa-file"></i> Viable Innovations</div>
