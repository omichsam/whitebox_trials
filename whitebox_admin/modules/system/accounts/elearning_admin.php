...
<div id="menu" class=" no_padding col-sm-12 col-xs-12 ">
    ...
    <div class=" nmk_controlsds diveconb  col-xs-12 col-sm-12" role="evaluating_divd" style="background:#000 !important;color:#fff !important;" >Content Team</div>
     <div class="col-xs-12 col-sm-12 no_padding not_shown menu_kkdivesm" id="evaluating_divd">
    ...
    <div class=" nmk_clerskdf nmk_controlsds   col-xs-12 col-sm-12"   role="tests"><i class="fa fa-line-chart"></i>  Tests/Surveys</div>
     <div class=" nmk_clerskdf nmk_controlsds   col-xs-12 col-sm-12"   role="performance"><i class="fa fa-line-chart"></i>  Perfomence</div>
      ...
      <div class=" nmk_clerskdf nmk_controlsds   col-xs-12 col-sm-12"   role="certificates"><i class="fa fa-certificate  "></i> Certificates</div>
       <div class=" nmk_clerskdf nmk_controlsds   col-xs-12 col-sm-12"   role="calender"><i class="fa fa-calendar  "></i> Calendar</div>
</div>
    <div class=" nmk_controlsds diveconb  col-xs-12 col-sm-12" role="executive_divd" style="background:#000 !important;color:#fff !important;" >Communications Team</div>
    <div class="col-xs-12 col-sm-12 no_padding not_shown menu_kkdivesm" id="executive_divd">
  ...
  <div class=" nmk_controlsds nmk_controlsdz    col-xs-12 col-sm-12"   role="chats"><i class="fa fa-comments"></i> Online chats</div>
   ...
   <!--<div class=" nmk_controlsds nmk_controlsdz   col-xs-12 col-sm-12"   role="forward"><i class="fa fa-forward"></i>  Forward Innovations</div>-->
     ...
     <div class=" nmk_controlsds diveconb  col-xs-12 col-sm-12" role="superadmin_divd" style="background:#000 !important;color:#fff !important;" >Super admin's menu</div>
 <div class="col-xs-12 col-sm-12 no_padding menu_kkdivesm" id="superadmin_divd">
