...
<div class="col-sm-12 col-xs-12" id="header_innovation"><h4 id="filter_headers">Submitted pitch videos <span class="btn theme_bg" id="export_files" style="float: right;"><i class="fa fa-download" ></i> Export</span></h4></div>  

<div class="col-sm-12 col-xs-12" id="filtered_data">

<div class="col-sm-12 no_padding col-xs-12 innovations_headers">
  <div class="col-xs-8 col-sm-8  content_h overflow_data" ><strong>NAME</strong></div>
 
     <div class="col-sm-2  no_padding marksholdered col-xs-1"><strong>PRACTICAL 1 </strong> </div>
     

     <div class="col-sm-2  no_padding marksholdered col-xs-1"><strong>ACTION </strong> </div>
...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
 <div class="col-sm-8  col-xs-8" style="text-transform:uppercase;"><?php echo $counter.". ".$name?></div>



     <div class="col-sm-2  no_padding marksholders videoaccess <?php echo $videosource?> col-xs-1" id='<?php echo $email?>' role='<?php echo $vid?>'></div>

       <div class="col-sm-2  marksholders col-xs-1 "><div class="col-sm-12 btn btn-success evaluates col-xs-12" id="<?php echo $prat?>">Evaluate </div></div>
...
<?php
 ...
 <div class="col-sm-8 col-xs-8" style="text-transform:uppercase;"><?php echo $counter." ".$name?></div>
     ...
     <div class="col-sm-2  no_padding marksholders videoaccess <?php echo $videosource?> col-xs-1" id='<?php echo $email?>' role='<?php echo $vid?>'></div>
       ...
       <div class="col-sm-2  marksholders col-xs-1 ">
        <div class="col-sm-12 btn btn-success evaluates col-xs-12" id="<?php echo $prat?>">Evaluate </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".evaluates").click(function(){
       var pract=$(this).attr("id");
        $.post("modules/system/judge/pages/view/evaluate.php",{pract:pract},function(data){
        $("#home").html(data)
      })
