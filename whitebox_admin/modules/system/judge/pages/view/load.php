...
<div id="wysiwyg_cp" class="col-sm-12 col-xs-12" style="padding:8px; width:100%;border: 1px solid #000;">
  ...
  <input type="button" onClick="iFontSize()" value="Font">
...
<form class="col-sm-12 col-xs-12 no_padding" id="myform">
   ...
   <iframe name="richTextField" id="richTextField"  class="col-sm-12 colxs-12" style="border:#000000 1px solid; height:300px;background: #fff;margin-top: 1px;" onload="feeddata()"></iframe>
   <div class="col-sm-12 col-xs-12">
     <div class=" col-sm-3 col-xs-2"></div><div class=" col-sm-6 col-xs-8 btn-primary btn" id="submitinformation">Submit</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#submitinformation").click(function(){
      ...
      if(richTextField){
        var txt;
  var r = confirm("Dou you wish to submit your information?, click OK to proceed or CANCEL to stop?");
  if (r == true) {
...
var role=btoa('<?php echo $role?>');
  ...
  var form_data = btoa(window.frames['richTextField'].document.body.innerHTML);
   ...
   $("#error_loading").html(data)
     ...
     var r = confirm("Dou you wish to clear the information?, click OK to proceed or CANCEL to stop?");
  if (r == true) {
