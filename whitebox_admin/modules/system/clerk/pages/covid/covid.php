...
<div class="col-sm-12 col-xs-12" id="header_innovation"><h4 id="filter_headers">COVID 19 INNOVATIONS</h4></div>	
...
$cheinnovations=mysqli_query($con,"SELECT * FROM covid19_innovations where Status='$submission'") or die(mysqli_error($con));
...
$next_page=$pageno+1;
 $no_of_records_per_page = 10;
       ...
       $allcounter=0; 
      $sqlx="SELECT * FROM covid19_innovations where Status='$submission'";
...
$sqlx="SELECT * FROM covid19_innovations where Status='$submission' LIMIT $offset,$no_of_records_per_page";
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/clerk/pages/covid/loadmore.php",{
            offset:offset
        },function(data){
...
$.post("modules/system/clerk/pages/covid/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
...
var url="modules/system/clerk/pages/covid/evaluate.php";
