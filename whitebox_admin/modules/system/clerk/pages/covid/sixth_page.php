...
$sqlx="SELECT * FROM covid19_innovations where id='$innovation'";
  ...
  $requirements=$row['relevancy'];

    $Innovation_name="COVID 19 Innovation";
$newrequirements_feedback="";
$newrequirements_question="";
$query_question="";
$requirements_feedback="";
$requirements_feedback="";
$show_question="not_shown";
$sqlxo="SELECT requirements_feedback FROM feedback where Innovation_id='$innovation' and status='$commments'";
...
$query_runxdol=mysqli_query($con,$sqlxol) or die($query_runxdol."<br/><br/>".mysqli_error($con));
  ...
  $requirements_question=$row['requirements_feedback'];
...
$query_question="Yes";
$show_question="";
$newrequirements_question=$requirements_question;
}else{
...
<div class="col-sm-8 col-xs-12 ">
  ...
  <div class="col-sm-12 colxs-12 default_header">RELEVANCY</div>
...
<div class="col-sm-12 no_padding col-xs-12" id="need_clarify">
  ...
  <div class="no_padding my_explainquestions <?php echo $show_question?> col-sm-12 col-xs-12">
    ...
    <textarea class=" col-sm-12 col-xs-12 questions_hold" id="solution_replythsix" maxlength="200" onkeyup="questionsixss(this.value)" placeholder="E.g Can i get to know more on the need?"><?php echo $newrequirements_question?></textarea>
...
<textarea id="comrequiremens_solution" maxlength="400" onkeyup="coment_trequre(this.value)" placeholder="Type your coments about the subject here max(400 characters)" class="coments col-sm-12 col-xs-12"><?php echo $newrequirements_feedback?></textarea>
...
function questionsixss(str) {
  ...
  $(document).ready(function(){
    ...
    var urla="modules/system/clerk/pages/covid/last_page.php";
var requirements='<?php echo $requirements?>';
if(requirements){
...
if($.trim(data)=="exist"){
    $.post(""+url+"",{
      ...
      $("#targeted_dcmorequire").html("Please give a feedback").css("color","red");
}
