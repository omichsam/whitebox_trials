...
$sqlx="SELECT * FROM covid19_innovations where id='$innovation'";
  ...
  $impact=$row['implementation_plan'];
...
$sqlxo="SELECT impact_feedback FROM covid_feedback where Innovation_id='$innovation' and status='$commments'";
...
$sqlxol="SELECT impact_feedback FROM covid_feedback where Innovation_id='$innovation' and status='$questions'";
...
$query_runxdol=mysqli_query($con,$sqlxol) or die($query_runxdol."<br/><br/>".mysqli_error($con));
  ...
  $need_question=$row['impact_feedback'];
...
$query_question="Yes";
$show_question="";
$newimpact_question=$need_question;
}else{
...
<div class="col-sm-8 col-xs-12 ">
  ...
  <div class="col-sm-12 colxs-12 default_header">IMPLEMENTATION PLAN</div>
...
<div class="col-sm-12 no_padding col-xs-12" id="need_clarify">
  ...
  <div class="no_padding my_explainquestions <?php echo $show_question?> col-sm-12 col-xs-12">
    ...
    <textarea class=" col-sm-12 col-xs-12 questions_hold" id="solution_replythree" maxlength="200" onkeyup="questionthree(this.value)" placeholder="E.g Can i get to know more on the need?"><?php echo $newimpact_question?></textarea>
...
<textarea id="comment_impact" maxlength="400" onkeyup="coment_solimpact(this.value)" placeholder="Type your coments about the subject here max(400 characters)" class="coments col-sm-12 col-xs-12"><?php echo $newimpact_feedback?></textarea>
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/clerk/pages/covid/fourth_page.php";
...
if($.trim(data)=="exist"){
    $.post(""+url+"",{
      ...
      $("#impact_dc").html("Please give your feedback").css("color","red");
}
