...
$sqlxo="SELECT solution_feedback FROM covid_feedback where Innovation_id='$innovation' and status='$commments'";
...
$sqlxol="SELECT solution_feedback FROM covid_feedback where Innovation_id='$innovation' and status='$questions'";
...
<textarea id="comment_solution" maxlength="400" onkeyup="coment_solution(this.value)" placeholder="Type your coments about the subject here max(400 characters)" class="coments col-sm-12 col-xs-12"><?php echo $newsolution_feedback?></textarea>
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/clerk/pages/covid/third_page.php";
...
if($.trim(data)=="exist"){
    $.post(""+url+"",{
      ...
      $("#solution_dc").html("Please give your feedback").css("color","red");
}
