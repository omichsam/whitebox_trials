...
//echo $my_pass;
$checkExist=mysqli_query($con,"SELECT * FROM covid_feedback WHERE Innovation_id='$innovation' and status='$status'") or die(mysqli_error($con));

  if(mysqli_num_rows($checkExist)!=0){
 $update=mysqli_query($con,"UPDATE covid_feedback SET $field='$my_comments' WHERE Innovation_id='$innovation' and status='$status'") or die(mysqli_error($con));
 if($new_question){
//$my_question=$new_question;
...
$update=mysqli_query($con,"UPDATE covid_feedback SET $field='$my_question' WHERE Innovation_id='$innovation' and status='$questions'") or die(mysqli_error($con));

 echo "success";
}else{
	$sql=mysqli_query($con,"INSERT INTO covid_feedback VALUE(null,
											'$user_id',
											'$innovation',
											'',
											'',
...
$checkquestions=mysqli_query($con,"SELECT * FROM covid_feedback WHERE Innovation_id='$innovation' and status='$status'") or die(mysqli_error($con));
