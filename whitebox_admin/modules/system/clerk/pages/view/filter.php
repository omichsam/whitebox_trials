...
$cheinnovations=mysql_query("SELECT * FROM innovations_table where Status='$submission'") or die(mysql_error());
...
$myvalue=base64_decode(decrypt($my_value,$key));
