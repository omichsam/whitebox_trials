<div class="col-sm-12 col-xs-12 no_padding">
  <div class="col-sm-12 col-xs-12 default_header bordered">Disapproved Innovations</div>

<?php
include "../../../../../connect.php";
include "../../../../../plugins/php_functions/security.php";
$submission=encrypt("first_disapproved",$key);
//$submission=encrypt("approved",$key);
$my_user=$_POST['my_id'];
$my_userde=base64_decode($my_user);
...
?>
<div class="col-xs-12 col-sm-12" style="text-align: right;"><span class="btn theme_bg more_innovations" role="first_disapproved">View All</span></div>
<?php
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".more_innovations").click(function(){
       ...
       $.post("modules/system/clerk/pages/dashboard/more.php",{my_role:my_role,my_id:my_id},function(data){
