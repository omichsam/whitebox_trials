...
<div class="col-sm-12 col-xs-12 no_padding">
	<div class="col-sm-12 col-xs-12 default_header bordered">SECOND EVALUATION REPORT PER MONTH</div>
...
?>
<canvas class="col-sm-12 col-xs-12" id="myreportsmonth"></canvas>
...
var ctx = document.getElementById('myreportsmonth').getContext('2d');
