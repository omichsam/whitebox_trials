...
<div class="col-sm-12 col-xs-12 evaluate_header" id="">PROCEED TO EVALUATE REPLIES FROM INNOVATOR</div>
<div class="col-sm-12 col-xs-12 no_padding">
<div class="col-sm-12 col-xs-12 ">
  <div class="col-sm-12 col-xs-12 innovation_areas" id="innovation_area">
    
  <div class="col-sm-12 col-xs-12 evaluate_header">INNOVATION DETAILS <span style="float:right;" class="btn theme_bg view_information" id="<?php echo $innovation?>">View Details</span></div>
...
<div class="col-sm-4 col-xs-12 "><span class="btn evaluate_butn theme_bg" role="back">Back</span> <span class="btn <?php echo $show_butons?> evaluate_butn theme_bg" role="evaluate">View Replies</span> </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var url="modules/system/clerk/pages/pending/view.php";
...
// var innovation='<?php echo $innovation?>';
    var my_url="modules/system/clerk/pages/pending/pending.php";
$.post(""+my_url+"",function(data){
  ...
  $(".view_information").click(function(){
    var innovation=btoa($(this).attr("id"));
 $.post("modules/system/clerk/pages/pending/viewinfor.php",{innovation:innovation},function(data){
$("#home").html(data);
 })
  })
  })
