...
$query_runxdol=mysqli_query($con,$sqlxol) or die($query_runxdol."<br/><br/>".mysqli_error($con));
  ...
  $impact_feedback_question=$row['impact_feedback'];

$Clerk_id=$row['Clerk_id'];
}
if($impact_feedback_question){
$check_impacts="Question";
...
$sqlxo="SELECT impact_feedback,Clerk_id FROM feedback where Innovation_id='$innovation' and status='$evaluate_replys'";
...
$sqlxol="SELECT impact_feedback FROM feedback where Innovation_id='$innovation' and status='$clerks_question'";

$query_runxdol=mysqli_query($con,$sqlxol) or die($query_runxdol."<br/><br/>".mysqli_error($con));

    while($row=mysqli_fetch_array($query_runxdol)){
  $needdd_question=$row['impact_feedback'];
...
$query_runxdol=mysqli_query($con,$sqlxol) or die($query_runxdol."<br/><br/>".mysqli_error($con));
  ...
  $impact_feedback_question=$row['impact_feedback'];
if($impact_feedback_question){
$impact_query=$impact_feedback_question;
}else{
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/clerk/pages/pending/fourth_page.php";
...
//END NO QUERY
  ...
  var check_impacts='<?php echo $check_impacts?>';
if(check_impacts==""){
 var innovats='<?php echo $innovation?>';
    var innovation=btoa(innovats);

    $.post("modules/system/clerk/pages/pending/fourth_page.php",{innovation:innovation},function(data){
    $(".evaluation_class").hide();
