...
$sqlxo="SELECT businessmodel_feedback FROM feedback where Innovation_id='$innovation' and status='$commments'";
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/clerk/pages/evaluate/sixth_page.php";
