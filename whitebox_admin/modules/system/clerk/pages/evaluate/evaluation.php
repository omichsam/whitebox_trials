...
$update=mysqli_query($con,"UPDATE innovation_stamps SET first_evaluation='$new_time',Clerk_id='$user_id' WHERE Innovation_Id='$innovation'") or die(mysqli_error($con));
