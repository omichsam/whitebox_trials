...
$email=$get['email'];  
 ...
 $message="<p>Dear ".$newFirst_name." ".$newLast_name.",</p><p>Your Innovation has successfully gone through the first level evaluation.</p><p>Kindly log into your portal account to view the feedback from the evaluation team.</p><p>Link https://www.whitebox.go.ke</p><p>&nbsp;</p><p>Regards,</p><p>Huduma WhiteBox</p>";
...
<div class="col-sm-12 col-xs-12" id="approved_part">
  ...
  <span class="btn  approve_btns btn-danger" role="disapproved">I Decline</span> 
    <span class="btn btn-success approve_btns" role="approved">I Accept</span> 
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   ...
   $("#send_button").click(function(){
    ...
    var update="modules/system/clerk/pages/evaluate/save_report.php";
    var next_destination="modules/system/clerk/pages/view/view.php";
