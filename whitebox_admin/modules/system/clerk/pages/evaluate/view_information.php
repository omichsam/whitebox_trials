...
<div class="col-sm-12 col-xs-12">
  <div class="col-sm-12 col-xs-12 default_header" id="head_fgt">INNOVATION DETAILS</div>
...
<div class="col-sm-3 col-xs-3 no_padding" style="text-align:rigt"><span class=" btn theme_bg close_feedb">Close <i class="fa fa-close"></i></span> <span class=" btn theme_bg Full_view">Full View <i class="fa fa-file"></i></span></div>
  </div>
...
<div class="col-sm-12 col-xs-12 feedback_dives" >
 ...
 What are you looking for as an innovator?
  ...
  <div class="col-sm-12 col-xs-12 narative_side">
    <div class="col-sm-12 col-xs-12 intro_head">Innovator's description on what he/she is looking for</div>
    <div class="col-sm-12 col-xs-12">
...
$.post(url,{innovation:innovation},function(data){$("#home").html(data)});
     ...
     $(".Full_view").click(function(){
       var innovation=btoa('<?php echo $innovation?>');
var url="modules/system/clerk/pages/evaluate/full_statement.php";
$.post(url,{innovation:innovation},function(data){$("#home").html(data)});
