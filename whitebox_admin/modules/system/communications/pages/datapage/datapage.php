...
<script type="text/javascript">
  $(document).ready(function(){
    $("#Uploadnew").click(function(){
     ...
     $.post("modules/system/callcenter/datapage/adddoc.php",{my_id:my_id},function(data){
      $("#home").html(data)
     })
    })
  })
...
<script type="text/javascript">
  $(document).ready(function(){
       ...
       $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/callcenter/datapage/loadmore.php",{
            offset:offset
        },function(data){
...
$.post("modules/system/callcenter/datapage/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
...
var innovation=$(this).attr("id");
   //alert(innovation);
  //alert(innovation);
//var url="modules/system/callcenter/datapage/feedback_view.php";
$.post("modules/system/callcenter/datapage/view.php",{innovation:innovation},function(data){
  $("#home").html(data);
  //alert(data);
