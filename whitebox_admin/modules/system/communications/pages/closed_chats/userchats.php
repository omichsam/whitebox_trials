...
<?php
include("../../../../../connect.php");
$email=mysqli_real_escape_string($con,base64_decode($_POST['chart_id']));
?>

<div class="col-sm-12 col-xs-12 no_padding" style="max-height: 200px;overflow: auto;min-height: 120px;">
<?php

$sqlxo="SELECT * FROM chat_backup where email='$email'";
...
<div class="col-sm-12 col-xs-12 charts_kichwad">
  ...
  </div>-->	<?php echo $fname?> <span class="take_over btn theme_bg" style="float:right;" id="<?php echo $chart_idn?>">View</span>
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   $.post("modules/system/communications/pages/closed_chats/takeoverclosed.php",{chart_id:chart_id,user:user},function(data){
