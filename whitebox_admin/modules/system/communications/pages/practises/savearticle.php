...
include("../../../../../connect.php");
    ...
    while($row=mysqli_fetch_array($query_runl)){
         ...
         $get_account=mysqli_query($con,"SELECT * FROM bestpractices WHERE refference_no ='$refferenceno' AND article_name='$article_name' AND Author='$author' and Pubblished_year='$published'") or die(mysqli_error($con));
...
$sql=mysqli_query($con,"INSERT INTO bestpractices VALUE(Null,
											'$refferenceno',
											'$article_name',
											'$author',
											'$volume',
       ...
       $sqlgp="SELECT id FROM bestpractices WHERE refference_no ='$refferenceno' AND article_name='$article_name' AND Author='$author' and Pubblished_year='$published'";
...
$update=mysqli_query($con,"UPDATE bestpractices SET Documet_dir='$new_names',thumbnails='$thumb' WHERE id='$docid_id'") or die(mysqli_error($con));
