...
<div class="col-sm-12 col-xs-12">
    ...
    <div class="col-sm-12 col-xs-12" id="certscount"></div>
</div>
...
include "../../../../../connect.php";
$sql="SELECT * FROM e_learning_users";
...
$count++;
    ...
    $name="$first_name &nbsp;&nbsp;  $Last_name";
     ...
     $get_userid=mysqli_query($con,"SELECT colm_11 FROM curriculum_module_coverage  WHERE colm_4='$useremail'") or die(mysqli_error($con));
$getp=mysqli_fetch_assoc($get_userid);
if($getp){
$module_done=$getp['colm_11'];
if($module_done){
   $certs++;
    
 ?>
                
                    <div class="col-lg-12 col-md-12 col-sm-12 no_padding mobile_hidden " data-aos="flip-up" style="margin-bottom:40px" id=""> 
                  
                
          <div class="col-lg-12 no_padding col-md-12 col-sm-12  "> 
...
<div class="col-lg-12 col-md-12 no_padding col-sm-12 col-md-12  no_padding" id="body_holding">
...
<div class="col-sm-12 col-xs-12" style="/*min-height: 2383px;*/font-size: 32px; text-align: center;">
    ...
    For participating <!--as a whitebox e-learner-->in the whitebox e-learning programme powered by the Kijiji. 
</div>
</div>
...
<div class="  col-sm-10 co-xs-10 display_id_det">
           <div class="p_d_b no_padding col-sm-12 col-xs-12">Mrs. Freyja Oddsdottir</div>
            ...
            $(document).ready(function(){
                var certificates_range='<?php echo "$certs out of $count"?>';
                $("#certscount").html(certificates_range);
            })  
