...
$sql="SELECT * FROM wp_feedback";
  ...
  $role_played=mysqli_real_escape_string($con,$row['role_played']);
  $likemost=mysqli_real_escape_string($con,$row['likemost']);
  $recommendations=mysqli_real_escape_string($con,$row['recommendations']);
