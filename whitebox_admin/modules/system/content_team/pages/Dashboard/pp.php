...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
 ...
 <div class="col-sm-1  no_padding marksholders <?php echo $module1?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module2?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module3?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module4?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module5?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module6?> col-xs-1"> </div>
<div class="col-sm-1  no_padding marksholders <?php echo $module7?> col-xs-1"> </div>
...
for($d=1;$d<=$Modules;$d++){
  $checkExist=mysqli_query($con,"SELECT * FROM curriculum_courses_coverage WHERE user_id='$user_id' AND unit_id='$d'") or die(mysqli_error($con));
