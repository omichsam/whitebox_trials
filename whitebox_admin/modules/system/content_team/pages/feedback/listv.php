...
$deleteed=mysqli_query($con,"DELETE FROM exports_tbl") or die(mysqli_error($con));
  ...
  $select_test=mysqli_query($con,"SELECT * FROM curriculum_test WHERE id='$test_id'") or die(mysqli_error($con));
...
$questions=0;
  //echo $my_pass;
$checkExist=mysqli_query($con,"SELECT * FROM curriculum_exam_area WHERE test_id='3' and user_id='$userid'") or die(mysqli_error($con));
