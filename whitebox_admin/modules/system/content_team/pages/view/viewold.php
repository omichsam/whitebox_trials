...
<div class="col-sm-12 col-xs-12" id="header_innovation"><h4 id="filter_headers">INNOVATIONS FROM WHITEBOX V1 <!--<span class="btn theme_bg" id="old_innovation" style="float: right;"><span class=" ">Old Innovations </span><span class="" style="color: red;font-weight: bolder"><?php echo $number?></span></span>--></h4></div>	
...
<div class="col-sm-1  col-xs-1">No.</div>
  ...
  <div class="col-sm-2 col-xs-1"><strong>ACTION <!--<span class="btn " id="export_innovations"><a href="modules/system/clerk/pages/view/export.php#" target="_blank">Export <i class="fa fa-download"></i></a> </span>--></strong> </div>
</div>
<?php
...
<div class="col-sm-1  col-xs-1"><?php echo $counter?></div>
  ...
  <div class="col-sm-2 col-xs-1"><strong><span id="<?php echo $Innovation_Id ?>" class=" veiw_evaluateg "><i class="fa fa-eye "></i><span class="mobile_hidden"> View</span></span> </strong> </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/clerk/pages/view/oldloadmore.php",{
            offset:offset
        },function(data){
...
var view_evaluate=".veiw_evaluateg";
var target="#infor_datas";
$(view_evaluate).click(function(){
  var innovation=$(this).attr("id");
var url="modules/system/clerk/pages/view/information.php";
