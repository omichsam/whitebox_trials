...
$sqlx="SELECT * FROM  curriculum_tests_done where unit_id='$unit_id' and test_id='$role'";
$counter=0;
...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
 <div class="col-sm-7 col-xs-10"><?php echo $counter.". ".$name?></div>

  <div class="col-sm-2 mobile_hidden no_padding col-xs-2"><strong><?php echo $time_d?> </strong> </div>
  <div class="col-sm-3 col-xs-2"><span class="btn viewtests" title="<?php echo $user_id?>" id="<?php echo $test_id?>" role="<?php echo $unit_id?>"> View</span></div>
  ...
  $(document).ready(function(){
    $(".viewtests").click(function(){
     ...
     var my_id=btoa($(this).attr('title'));
      $.post("modules/system/content_team/pages/tests/view.php",{test_id:test_id,unit_id:unit_id,my_id:my_id},function(data){
        $("#home").html(data)
      })
    })
  })
