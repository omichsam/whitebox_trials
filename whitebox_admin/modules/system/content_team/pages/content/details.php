...
$description=mysqli_real_escape_string($con,base64_decode($_POST['description']));
	$sql="SELECT * FROM curriculum_units WHERE description='$name' and more_information='$description'";
...
<div class="col-sm-12 col-xs-12 "> <div class="col-sm-12 col-xs-12 btn btn-primary" id="add_menu">Add sub topic</div>
