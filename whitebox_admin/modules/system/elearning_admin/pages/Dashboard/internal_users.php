...
<div class="col-sm-12 col-xs-12" id="table_headers">
    ...
    <div class="col-sm-2 mobile_hidden">last log</div>
...
include "../../../../../plugins/php_functions/security.php";
  ...
  $offline_data="";
$statusof="online";
$admin="elearning_admin";

$sqlx="SELECT * FROM  administrators  where Admin_role='content_team' or Admin_role='communications' or Admin_role='elearning_admin'";
$counter=0;
  ...
  if($Admin_role=="elearning_admin"){
$Admin_role="Admin";
  }else if($Admin_role=="content_team"){
$Admin_role="Content team";
  }else{
    //$Admin_role=$row['Admin_role'];
  }
  $time_in=$row['time_in'];
...
$time_dout="";
  ...
  if($counter % 2 != 0){
    ?>
  <div class="col-sm-12 col-xs-12 external_udata table_datas" id="<?php echo $user_id?>">
    <div class="col-sm-1 col-xs-1"><?php echo $counter?></div>
    <div class="col-sm-3 col-xs-4"><?php echo $Name?></div>
    <div class="col-sm-2 mobile_hidden"><?php echo $Admin_role?></div>
  ...
  ?>
<div class="col-sm-12 col-xs-12 external_udata table_data" id="<?php echo $user_id?>">
    <div class="col-sm-1 col-xs-1"><?php echo $counter?></div>
    <div class="col-sm-3 col-xs-4"><?php echo $Name?></div>
    <div class="col-sm-2 mobile_hidden"><?php echo $Admin_role?></div>
...
$(document).ready(function(){
    setTimeout(data_banalytics, 30000);
    $(".external_udata").click(function(){
      var user=$(this).attr("id");
      //alert(user)

    })
  })
  function data_banalytics(){

  $.get("modules/system/elearning_admin/pages/Dashboard/internal_users.php",function(data){$("#internal_users").html(data)})
}
