...
$deleted = mysqli_query($con,"SELECT * FROM  deleted_content where type='learner' and status='new'");
$alldeleted= mysqli_num_rows($deleted);

?>
<div class="col-sm-12 col-xs-12">
<div class="col-sm-12 col-xs-12" id="header_innovation"><h4 id="filter_headers">REGISTERED LEARNERS <span style="float:right;margin-bottom: 2px;" id="view_deleted" class="btn theme_bg">View Deleted [<?php echo $alldeleted?>]</span></h4></div> 
...
$cheinnovations=mysqli_query($con,"SELECT * FROM e_learning_users") or die(mysqli_error($con));
...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
  ...
  <div class="col-sm-1 col-xs-1"><strong><span id="<?php echo $usersid ?>" class=" veiw_evaluate "><i class="fa fa-trash "></i><span class="mobile_hidden"> Delete</span></span> </strong></div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/elearning_admin/pages/manageusers/loadmore.php",{
            offset:offset
        },function(data){
...
$.post("modules/system/elearning_admin/pages/manageusers/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
...
$(view_evaluate).click(function(){
  ...
  var txt;
  var r = confirm("Are you sure you wish to delete this user?, click OK to proceed or CANCEL to stop?");
  if (r == true) {
var url="modules/system/elearning_admin/pages/manageusers/delete.php";


$.post(url,{usersid:usersid,user:user},function(data){

if($.trim(data)=="success"){
$.post("modules/system/elearning_admin/pages/manageusers/manageusers.php",{},function(data){
  $(target).html(data)
...
var url="modules/system/elearning_admin/pages/manageusers/viewold.php";
$.post(url,function(data){$("#filtered_data").html(data)});
})


$("#export_innovations").click(function(){
 var url="modules/system/elearning_admin/pages/manageusers/exportone.php";
 var target="#home";
...
$("#view_deleted").click(function(){
  $.post("modules/system/elearning_admin/pages/manageusers/deleted.php",function(data){
    $("#home").html(data);
  })
})
