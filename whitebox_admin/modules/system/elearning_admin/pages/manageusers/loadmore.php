...
<div class="col-sm-12 no_padding col-xs-12 innovations_holder">
  ...
  <div class="col-sm-1 col-xs-1"><strong><span id="<?php echo $userid ?>" class=" veiw_evaluate "><i class="fa fa-trash "></i><span class="mobile_hidden"> Delete</span></span> </strong> </div>
