...
<div class="col-sm-12 col-xs-12 no_padding">
	<div class="col-sm-12 col-xs-12 default_header bordered"><?php echo $pagetittle?></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".graphfilters").click(function(){
			...
			$.post('modules/system/elearning_admin/pages/datapage/filtergraph.php',{dataid:dataid,grapghtype:grapghtype,filtered:filtered},function(data){
