...
<div class="col-sm-12 col-xs-12 controls_holders no_padding">
    ...
    <div class=" nmk_controls    col-xs-12 col-sm-12"   role="view"><i class="fa fa-creative-commons"></i> Received Innovations</div>
    <div class=" nmk_controls   col-xs-12 col-sm-12"   role="pending"><i class="fa fa-creative-commons"></i>Pending Innovations</div>
   <!-- <div class=" nmk_controls   col-xs-12 col-sm-12"   role="generate"> <i class="fa fa-book"></i> Generate Report</div>-->
