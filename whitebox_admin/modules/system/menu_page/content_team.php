...
<script type="text/javascript">
   ...
   $(".nmk_controls").click(function(){
    ...
    //$("#menu_page").removeClass("slideInLeft").addClass("slideOutLeft");
				...
				$("#loaderholdings").html("Loading.."+loader);
...
<div class="col-sm-12 col-xs-12 controls_holders no_padding">
   ...
   <div class=" nmk_controls     col-xs-12 col-sm-12"   role="view"><i class="fa fa-users"></i>  Registered members</div>
    <!--<div class=" nmk_controls  col-xs-12 col-sm-12"   role="content"><i class="fa fa-list"></i>  Content </div>-->
    <div class="  nmk_controls   col-xs-12 col-sm-12"   role="tests"><i class="fa fa-line-chart"></i>  Tests/Surveys</div>
     <div class="  nmk_controls   col-xs-12 col-sm-12"   role="performance"><i class="fa fa-line-chart"></i>  Perfomence</div>
     <div class="  nmk_controls   col-xs-12 col-sm-12"   role="feedback"><i class="fa fa-comments"></i>  Feedback</div>

      <div class=" nmk_controls    col-xs-12 col-sm-12"   role="caverage"><i class="fa fa-bar-chart  "></i>  Module coverage</div>
      <div class=" nmk_controls    col-xs-12 col-sm-12"   role="practicles"><i class="fa fa-lightbulb-o  "></i> Practicals</div>
    <div class=" nmk_controls   col-xs-12 col-sm-12"   role="logout"> <i class="fa fa-sign-out"></i> Logout</div>
    <div class="col-sm-12 col-xs-12" id="loaderholdings"></div>
</div>
