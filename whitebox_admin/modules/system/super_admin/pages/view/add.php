...
$chars ="ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopqrstuvwxyz";
 ...
 $query=mysqli_query($con,"INSERT INTO administrators
         ...
         $message="<p>Dear $name</p><p>Your innovation portal acoount has been created. Kindly access the WhiteBox Innovation portal  via the link: https://www.whitebox.go.ke/whitebox_admin.</p><p>Your account cridentials are:</p><p> Username: $send_email </p><p> password: $code</p><p>Regards</p><p>Huduma WhiteBox</p>";  
