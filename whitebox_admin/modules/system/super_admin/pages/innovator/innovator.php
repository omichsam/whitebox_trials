...
<div class="col-sm-12 col-xs-12" id="maininnovate">
  <div class="col-sm-12 col-xs-12 default_header">REGISTERED USERS <span style="float:right"><span class="btn" id="expand_win"><i class="fa fa-expand"></i></span><span class="btn not_shown" id="minimise_win"><i class="fa fa-window-minimize"></i></span></span> <span class="btn btn-primary" style="float:right;" id="exportdata">Export <i class="fa fa-download"></i></span></div>
...
$("#exportdata").click(function(){
  $.post("modules/system/clerk/pages/Dashboard/export.php",{
...
$("#minimise_win").click(function(){
    ...
    $(this).hide();
       ...
       // alert(offset)
        $.post("modules/system/clerk/pages/Dashboard/loadmore.php",{
            offset:offset
        },function(data){
