             ...
             //  alert(role)
               if(role=="back"){
                ...
                $("#disclosure_error").html(loader);
                  $.post("modules/system/super_admin/pages/notifications/notifications.php",function(data){
                $("#home").html(data);
            })  
               }else{
               var my_id='<?php echo $my_userde ?>';
               var myrole=btoa(role);
                  $.post("modules/system/super_admin/pages/notifications/update_role.php",{
                      my_id:my_id,
                      myrole:myrole
                      },function(data){
