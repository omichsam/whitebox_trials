...
$delete=mysqli_query($con,"DELETE FROM notify_tray where action='move' and Status='new' and host_id='$host_id'") or die(mysqli_error($con));


?>
<div class="col-xs-12 col-sm-12">
<div class="col-xs-12 col-sm-12 default_header">Move innovations</div>
	...
	var search=btoa($("#search_field").val());
      ...
      $("#selected_pages").html("")
       ...
       if($.trim(data)=="success"){
	      $.post("modules/system/super_admin/pages/manage/select_option.php",{user:user,action:action},function(responce){
            $(".notify_alld").hide();
