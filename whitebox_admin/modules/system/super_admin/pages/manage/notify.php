...
<div class="col-xs-12 col-sm-12 default_header">Notify</div>
	...
	var search=btoa($("#search_field").val());
      ...
      $("#selected_pages").html("")
       ...
       if($.trim(data)=="success"){
	      $.post("modules/system/super_admin/pages/manage/send_notification.php",{user:user,action:action},function(responce){
            $(".notify_alld").hide();
