...
$get=mysqli_fetch_assoc($get_user);
  $newFirst_name=mysqli_real_escape_string($con,$get['first_name']);
$newLast_name=mysqli_real_escape_string($con,$get['last_name']); 
$email=mysqli_real_escape_string($con,$get['email']); 
