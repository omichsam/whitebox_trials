...
<script type="text/javascript">
  $(document).ready(function(){
    $("#Uploadnew").click(function(){
     ...
     $.post("modules/system/super_admin/pages/datapage/adddoc.php",{my_id:my_id},function(data){
      $("#home").html(data)
     })
    })
  })
...
<div class="col-sm-12 col-xs-12">
  <span class="theme_bg btn" id="Uploadnew">Upload new</span>
...
<script type="text/javascript">
  $(document).ready(function(){
       ...
       $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/super_admin/pages/loadmore.php",{
            offset:offset
        },function(data){
...
$.post("modules/system/super_admin/pages/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
...
var innovation=$(this).attr("id");
   //alert(innovation);
  //alert(innovation);
//var url="modules/system/super_admin/pages/feedback_view.php";
$.post("modules/system/super_admin/pages/datapage/view.php",{innovation:innovation},function(data){
  $("#home").html(data);
  //alert(data);
