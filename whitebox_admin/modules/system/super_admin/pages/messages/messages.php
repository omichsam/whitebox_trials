...
Subject:<input type="name" placeholder="e.g Meeting optional" class="splashinputs" id="subject">
       ...
       <div class="col-sm-6 col-xs-12">
        Cc:<input type="email" class="splashinputs" placeholder="email@example.com optional" id="copy_email">
       </div>
       <div class="col-sm-6 col-xs-12 not_shown" id="single_person">
        Email:<input type="email" class="splashinputs" placeholder="email@example.com" id="reciever">
       </div>
      ...
      <div class="col-sm-4 col-xs-12"> 
       ...
       <div class="col-sm-4 col-xs-12"><span class="btn theme_bg" id="send_email">send Message</span></div>
       </div>
...
$("#send_email").click(function(){
    var reciever=$("#select_reciever").val();

var copy_email=$("#copy_email").val();
var message_box=$("#message_box").val();
var subject=$("#subject").val();
    if(reciever && subject && message_box){
      checksecurity();
   
}else{
   $("#messageerror").html("Some fields are Required!");  
}
})
  ...
  if (person == null || person == "") {
    ...
    if(person==secret){
var r = confirm("Are you sure you want to send this message?,Kindly confirm that you are sending this email to the right people, click OK to proceed or CANCEL to stop ?");
  if (r == true) {
...
$.post("modules/system/super_admin/pages/messages/send.php",{
