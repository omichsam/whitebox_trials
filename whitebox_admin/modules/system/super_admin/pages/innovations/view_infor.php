                                 ...
                                 $coutm=0;
                                  $sqlx="SELECT * FROM innovators_partners where Innovation_Id='$Innovation_Id'";
                                   ...
                                   ?>
                                    ...
                                    <tr class="<?php echo $showdocs?>"><td>Supporting Document </td><td id="PastAssociationd"><?php echo $documenth?><span style="float: right;" class="btn view_doct" id="<?php echo $attachments?>"><i class="fa fa-eye"></i>View</span></td></tr>-->
