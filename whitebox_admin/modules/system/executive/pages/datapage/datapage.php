...
<script type="text/javascript">
  $(document).ready(function(){
    $("#Uploadnew").click(function(){
     ...
     $.post("modules/system/executive/datapage/adddoc.php",{my_id:my_id},function(data){
      $("#home").html(data)
     })
    })
  })
...
<script type="text/javascript">
  $(document).ready(function(){
       ...
       $(".next_paged").click(function(){
        ...
        var offset=endpages;
       // alert(offset)
        $.post("modules/system/executive/datapage/loadmore.php",{
            offset:offset
        },function(data){
...
$.post("modules/system/executive/datapage/filter.php",{
my_role:my_role,
my_value:my_value
},function(data){
...
var innovation=$(this).attr("id");
   //alert(innovation);
  //alert(innovation);
//var url="modules/system/executive/datapage/feedback_view.php";
$.post("modules/system/executive/datapage/view.php",{innovation:innovation},function(data){
  $("#home").html(data);
  //alert(data);
