...
<div class="col-sm-3 col-xs-3 no_padding" ><span class=" btn theme_bg close_feedb" style="text-align:right">Close <i class="fa fa-close"></i> </span> <span class=" btn theme_bg View_full" id="<?php echo $innovation?>" style="text-align:right">Full Details <i class="fa fa-file-pdf-o"></i></span></div>
  </div>
...
<div class="col-sm-12 col-xs-12 feedback_dives" >
 ...
 What are you looking for as an innovator?
  ...
  <div class="col-sm-8 col-xs-12 narative_side">
    <div class="col-sm-12 col-xs-12 intro_head">Innovator's description on what you were looking for</div>
    <div class="col-sm-12 col-xs-12">
...
var url="modules/system/executive/pages/view/full_statement.php";
...
var my_id=$("#global_u_email").val();
  //alert(innovation);
var url="modules/system/executive/pages/view/view.php";
$.post(url,function(data){$("#home").html(data)});
})
