...
$query = "SELECT Innovation_name,stage,innovator_type,need,solution,impact,busines_model,target,Research_sources,requirements,Status,email,phone FROM innovations_table INNER JOIN users ON innovations_table.user_id=users.id AND innovations_table.Status='implementation'";
