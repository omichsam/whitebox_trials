...
$sqlxo="SELECT need_feedback,Clerk_id FROM feedback where Innovation_id='$innovation' and status='$commments'";
...
$(".my_explainquestions").hide()
    ...
    var urla="modules/system/executive/pages/evaluate/second_page.php";
...
if($.trim(data)=="exist"){
    $.post(""+url+"",{
      ...
      $("#counter_ct").html("Please give a feedback").css("color","red");
}
