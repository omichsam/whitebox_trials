...
$.post("modules/system/executive/pages/evaluate/media_client.php",{field:field,role:role,target:target},function(data){
...
$.post("modules/system/executive/pages/evaluate/media_client.php",{field:field,role:role,target:target},function(data){
 if($.trim(data=="success")){
  ...
  $.get("modules/system/executive/pages/evaluate/other_viewers.php",function(data){$("#viewers_area").html(data)})
}
</script>