  ...
  $(document).ready(function(){
    ...
    $(".view_doctet").click(function(){
      ...
      if(doc_data){
          //$("#pdf_shows").attr("src")="doc_data";
            $.post("modules/system/executive/pages/view/property.php",{page:page,doc_data:doc_data,innovation:innovation},function(data){
       $("#home").html(data);
})
      }else{
   ...
   // var innovation=btoa('<?php echo $innovation?>');
    $(".view_doct").click(function(){
      ...
      if(doc_data){
          //$("#pdf_shows").attr("src")="doc_data";
            $.post("modules/system/executive/pages/view/documents.php",{page:page,doc_data:doc_data,innovation:innovation},function(data){
       $("#home").html(data);
})
      }else{
    ...
    $(".close_fulld").click(function(){
      ...
      $.post("modules/system/executive/pages/evaluate/evaluate.php",{innovation:innovation},function(data){
       $("#home").html(data);
       });
    })
  })
