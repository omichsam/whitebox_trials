...
$(document).ready(function(){
	...
	if(scrw>768){
		//$("#sms_group_notifier_wrap").parent().addClass('pc_custom');
	}else{}
...
<div class="col-sm-12 col-xs-12 no_padding animated  slideInLeft custombg" id="sms_group_notifier_wrap">
	<div class="s100 float_left full no_padding " id="chatsection">
		<div class="s100 float_left pagebox_head" id="pagebox_head">
			<i class="btn   fa fa-arrow-left close_chatbtn float_left"   onclick="close_page('sms_group_notifier_wrap')"></i>
			 <div class="float_left col-sm-3 col-xs-8 no_padding">
				 <strong class="pageboxview_lbl float_left">SMS group notifier</strong>				 
			 </div>
 		</div>
