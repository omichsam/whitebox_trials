                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 logins " id="login_page">
                        <div class="card-header">
                            ...
                            <a data-dismiss="modal" style="cursor:pointer;"><img src="Huduma_WhiteBox/Whitebox.png"
                                    alt="logo" class="logo_positiondd" style="float: right;"></a>

                            <!--  <img src="https://www.whitebox.go.ke/assets/images/Whitebox.logo.png" alt="logo" class="" width="150px" style="float: right;" > -->
                        </div>
                        <span id="open_elerning" class="btn " style="float: left;cursor:pointer"> &nbsp;&nbsp;Sign-up to
                            e-learning</span>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" class="omb_loginForm bv-form" autocomplete="off" method="POST"
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="email" id="username" class="form-control" name="email"
                                        placeholder="Email" data-bv-field="email">
                                    <small style="display: none;" class="help-block" data-bv-validator="notEmpty"
                                        data-bv-for="email" data-bv-result="NOT_VALIDATED">The email address is
                                        required</small>
                                    <small style="display: none;" class="help-block" data-bv-validator="emailAddress"
                                        data-bv-for="email" data-bv-result="NOT_VALIDATED">The input is not a valid
                                        email address</small>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input id="password-field" type="password" class="form-control"
                                        placeholder="Password" name="password" data-bv-field="password">
                                    <!-- <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>-->
                                    <small style="display: none;" class="help-block" data-bv-validator="notEmpty"
                                        data-bv-for="password" data-bv-result="NOT_VALIDATED">Password is
                                        required</small>


                                    <small style="display: none;" class="help-block" data-bv-validator="different"
                                        data-bv-for="password" data-bv-result="NOT_VALIDATED">Password should not match
                                        user Name</small>
                                </div>
                                <span class="help-block"></span>
                                <div class="checkbox">
                            ...
                            <div class="icheckbox_minimal-blue" style="position: relative;">
                                ...
                                <div style="text-align: center;color:red" id="error_data"></div>
                    ...
                    <a href="https://www.whitebox.go.ke/google" class="social text-danger"><i class=" fa fa-google-plus"></i> Google</a>
                        ...
                        <div class="card-footer bg-light animation flipInX text-center">
                            ...
                            <div>Don't have an account? <a id="back_toregister" style="cursor:pointer"><strong> Sign
                                        Up</strong></a></div>
                        </div>
                    </div>
                    ...
                    <div class="animation not_shown logins  col-md-12" id="pass_resetpage">
                        <div class=" col-sm-12 no_padding ">
                            <div class="card-header">
                                ...
                                <a href=""><img src="Huduma_WhiteBox/Whitebox.png" alt="logo" class="logo_positiondd"
                                        style="float: right;"></a>
                            </div>
                            ...
                            <div class="recover_dives card-body" id="rec_ver">
                                ...
                                <form action="" id="recover_form" class="omb_loginForm bv-form" autocomplete="off"
                                    method="POST" novalidate="novalidate"><button type="submit" class="bv-hidden-submit"
                                        style="display: none; width: 0px; height: 0px;"></button>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control email" id="remail" name="remail"
                                            placeholder="Email" data-bv-field="remail">
                                        <span class="help-block"></span>
                                        <small style="display: none;" class="help-block" data-bv-validator="notEmpty"
                                            data-bv-for="email" data-bv-result="NOT_VALIDATED">The email address is
                                            required</small><small style="display: none;" class="help-block"
                                            data-bv-validator="emailAddress" data-bv-for="email"
                                            data-bv-result="NOT_VALIDATED">The input is not a valid email
                                            address</small>
                                    </div>
                                    <div class="form-group">
                                        <span id="recover_now" class="form-control btn btn-primary btn-block">Reset Your
                                            Password</span>
                            ...
                            <div class="card-body not_shown recover_dives" id="new_pass">
                                ...
                                <form action="" id="recovernew_form" class="omb_loginForm bv-form" autocomplete="off"
                                    method="POST" novalidate="novalidate"><button type="submit" class="bv-hidden-submit"
                                        style="display: none; width: 0px; height: 0px;"></button>
                                    <input name="_token" type="hidden" value="Tj49UXnOvOaG5RNZ8U2dBFE8LO4DCdJfUus178OX">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control email" id="code" name="code"
                                            placeholder="confirmation key" data-bv-field="remail">
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="form-group">
                                        <span id="confirm_now" class="form-control btn btn-primary btn-block">Confirm
                                            code</span>
                            ...
                            <div class="card-body not_shown recover_dives" id="confirm_mcodes">
                                ...
                                <form action="" id="recovernew_form" class="omb_loginForm bv-form" autocomplete="off"
                                    ...
                                    <div class="form-group">
                                        <span id="confirm_codesd"
                                            class="form-control btn btn-primary btn-block">Confirm</span>
                            ...
                            <div class="card-body not_shown recover_dives" id="newnow_pass">
                                ...
                                <form action="" id="new_passset" class="omb_loginForm bv-form" autocomplete="off"
                                    method="POST" novalidate="novalidate"><button type="submit" class="bv-hidden-submit"
                                        style="display: none; width: 0px; height: 0px;"></button>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="col-md-6" style="margin-top: 5px;">
                                            ...
                                            <input type="password" class="form-control email" id="password_n"
                                                name="password_n" placeholder="New Password" data-bv-field="remail">
                                        </div>
                                        <div class="col-md-6" style="margin-top: 5px;">
                                            <label class="sr-only">Confirm Password</label>
                                            <input type="password" class="form-control email" id="new_passworn"
                                                name="new_passworn" placeholder="Repeat Password"
                                                data-bv-field="remail">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">

                                        <span id="create_newpass" class="form-control btn btn-primary btn-block">Save
                                            Password</span>
                    ...
                    <div class="animation not_shown logins  col-md-12" id="register_page">
                        ...
                        <div class="card-body col-md-12">
                            ...
                            <div class="row justify-content-center ">
                                <form action="" method="POST" id="reg_form" novalidate="novalidate" class="bv-form">
                                    ...
                                    <div class=" row">
                                        <div class="form-group  col-md-6  col-sm-6">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name"
                                                placeholder="First Name" data-bv-field="first_name">

                                            <small style="display: none;" class="help-block"
                                                data-bv-validator="notEmpty" data-bv-for="first_name"
                                                data-bv-result="NOT_VALIDATED">Name is required</small>
                                        </div>

                                        <div class="form-group col-md-6  col-sm-6 ">
                                            <label class="sr-only"> Last Name</label>
                                            <input type="text" class="form-control" id="last_name" name="last_name"
                                                placeholder="Last Name" data-bv-field="last_name">

                                            <small style="display: none;" class="help-block"
                                                data-bv-validator="notEmpty" data-bv-for="last_name"
                                                data-bv-result="NOT_VALIDATED">Last name is required</small>
                                        </div>
                                        <div class="form-group col-md-6  col-sm-6">
                                            <label class="sr-only"> Email</label>
                                            ...
                                            <small style="display: none;" class="help-block"
                                                ...
                                                data-bv-result="NOT_VALIDATED">The email address is
                                                required</small><small style="display: none;" class="help-block"
                                                data-bv-validator="regexp" data-bv-for="email"
                                                data-bv-result="NOT_VALIDATED">The input is not a valid email
                                                address</small><small style="display: none;" class="help-block"
                                                data-bv-validator="emailAddress" data-bv-for="email"
                                                data-bv-result="NOT_VALIDATED">Please enter a valid email
                                                address</small>
                                        </div>
                                        <div class="form-group col-md-6  col-sm-6">
                                            <label class="sr-only"> Phone Number</label>
                                            <input type="phone" class="form-control" id="phone" name="phone"
                                                maxlength="13" placeholder="Phone Number" data-bv-field="phone">

                                            <small style="display: none;" class="help-block"
                                                data-bv-validator="notEmpty" data-bv-for="phone"
                                                data-bv-result="NOT_VALIDATED">The phone number is required</small>
                                        </div>
                                    </div>
                        ...
                        <label class="radio-inline">
                            <div class="iradio_minimal-blue" style="position: relative;"><input type="radio" class="pancityd"  style="opacity: 1 !important"  name="gender" id="inlineRadio2" value="female" style="position: absolute; " data-bv-field="gender"></div> Female
                                            ...
                                            <small style="display: none;" class="help-block"
                                                data-bv-validator="notEmpty" data-bv-for="gender"
                                                data-bv-result="NOT_VALIDATED">Gender is required</small>
                                        ...
                                        <div class="form-group col-md-6  col-sm-6" ng-app="myapp">
                                            <div class="col-sm-12 no_padding" ng-controller="PasswordController">
                                                ...
                                                <input type="password" class="form-control" id="newpassword"
                                                    ...
                                                    data-bv-field="newpassword" ng-model="newpassword"
                                                    ng-change="analyze(newpassword)">

                                                <small style="display: none;" class="help-block"
                                                    data-bv-validator="notEmpty" data-bv-for="password"
                                                    data-bv-result="NOT_VALIDATED">Password is required</small><small
                                                    style="display: none;" class="help-block"
                                                    data-bv-validator="different" data-bv-for="password"
                                                    data-bv-result="NOT_VALIDATED">Password should not match first/last
                                                    Name</small>


                                                <div class="col-xs-12 col-sm-12">
                                                    <div class="col-sm-12 col-xs-12 not_shown" id="pass_t">Password
                                                        strength:<span id="str_stregnth"></span></div>
                                                    <div class="col-xs-12 col-sm-12 " id="strengthmeter"
                                                        ng-style="passwordStrength"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6  col-sm-6 " ng-app="dmyapp">
                                            <div class="col-sm-12 no_padding" ng-controller="dPasswordController">
                                                ...
                                                <input type="password" class="form-control" id="password_confirm"
                                                    ...
                                                    ng-change="analyzed(password_confirm)">

                                                <small style="display: none;" class="help-block"
                                                    data-bv-validator="notEmpty" data-bv-for="password_confirm"
                                                    data-bv-result="NOT_VALIDATED">Confirm Password is
                                                    required</small><small style="display: none;" class="help-block"
                                                    data-bv-validator="identical" data-bv-for="password_confirm"
                                                    data-bv-result="NOT_VALIDATED">Please enter the same
                                                    value</small><small style="display: none;" class="help-block"
                                                    data-bv-validator="different" data-bv-for="password_confirm"
                                                    data-bv-result="NOT_VALIDATED">Confirm Password should match with
                                                    password</small>


                                                <div class="col-xs-12 col-sm-12">
                                                    <div class="col-sm-12 col-xs-12 not_shown" id="pass_t">Password
                                                        strength:<span id="dstr_stregnth"></span></div>
                                                    <div class="col-xs-12 col-sm-12 " id="dstrengthmeter"
                                                        ng-style="dpasswordStrength"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                                ...
                                                <div class="copy">
                                                    <label style="text-align: justify;">
                                                        <p>The Participants agree that by submitting their idea,
                                                            ...
                                                            conditions which
                                                            constitute a legally binding agreement between the
                                                            Government and the
                                                            Participants.Further,the Participants in registering with
                                                            the Facility confirm
                                                            that they have read and fully understood and accepted these
                                                            terms and
                                                            conditions.</p>
                                                    </label>
                                                    <div style="text-align: justify;">
                                                        <ol>
                                                            <li>
                                                                The Government is under no obligation to take up the
                                                                idea, innovation or the
                                                                product or apply it in any manner whatsoever;

                                                            </li>
                                                            <li>
                                                                The Government is not responsible for the protection of
                                                                the intellectual
                                                                property rights for the idea, innovation or the product
                                                                and neither does it
                                                                guarantee any such protection within the Whitebox
                                                                Facility. The Participants
                                                                are advised to follow through with the appropriate
                                                                Government bodies for the
                                                                protection of their intellectual property rights.

                                                            </li>
                                                            <li>
                                                                The Participants agree that they are voluntarily
                                                                entering in the Whitebox
                                                                Facility and fully understand its mode of operation.
                                                                Their engagement with
                                                                the Government and its partners is not compulsory and
                                                                they can choose to opt
                                                                out at any given time.
                                                            </li>
                                                            <li>
                                                                The Participants acknowledge that the Whitebox Facility
                                                                is not responsible
                                                                for any contracts that the Participants may enter with
                                                                any of the Facility’s
                                                                partners. Any such contractual engagements or dealings
                                                                are willingly entered
                                                                by the Participants and they do not create any privity
                                                                with the Government.

                                                            </li>
                                                            <li>
                                                                The Participants fully understand the objectives of
                                                                Whitebox Facility and as
                                                                such the Participants have without any inducement or
                                                                coercion submitted
                                                                their ideas, innovations and products to the Facility
                                    ...
                                    <div class="" id="termsholder">
                                        <label class="checkbox-inline" id="termsagree">
                                            <input required="" checked="true" class="pancityd" id="termsabd"
                                                name="termsa" type="checkbox" style="opacity: 1 !important"> I accept <a
                                                href="#modal"> Terms and Conditions</a>
                                        </label>
                                    </div>
                                    &nbsp;
                                    <!-- <button type="submit" class="btn btn-block btn-primary">Sign Up</button> -->
                                    <span class="btn btn-block btn-primary" name="SubmitButton" id="SubmitButton">Sign
                                        Up</span>
                        ...
                        <div class="card-footer text-center">
                            <div>Already have an account? Please <a style="cursor:pointer;" id="back_tologin"> Log
                                    In</a></div>
                    ...
                    <div class="animation not_shown logins  col-md-12" id="elearning_page">
                                ...
                                <form action="" method="POST" id="commentForm" novalidate="novalidate" class="bv-form">
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="text" name="fname" id="fname" class="splashinputs"
                                                minlength="3" maxlength="100">

                                        </div>
                                        <div class="col-sm-6 col-sm-12">
                                            Last Name:<span class="required">*</span>
                                            <input type="text" name="sname" id="sname" class="splashinputs"
                                                minlength="3" maxlength="100">
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <select class="splashinputs" minlength="3" maxlength="100" name="genderb"
                                                id="genderb">
                                                <option></option>
                                                <option>Male</option>
                                                <option>Female</option>
                                        ...
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="date" name="DateOfBirth" data-date-format="YYYY-MM-DD"
                                                id="DateOfBirth" class="splashinputs" minlength="3" maxlength="100">
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="email" name="emaile" id="emaile" class="splashinputs"
                                                minlength="3" maxlength="100">

                                        </div>
                                        <div class="col-sm-6 col-sm-12">
                                            Phone No:<span class="required">*</span>
                                            <input type="text" name="phoneb" id="phoneb" class="splashinputs"
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <select class="splashinputs" minlength="3" maxlength="100" name="county"
                                                id="county">
                                        ...
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <select name="education" id="education" class="splashinputs" minlength="3"
                                                maxlength="100">
                                                <option></option>
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="text" name="Innovation" id="Innovation" placeholder="Optional"
                                                class="splashinputs" minlength="3" maxlength="100">

                                        </div>
                                        <div class="col-sm-6 col-sm-12">
                                            Stage of Innovation:
                                            <select name="stage" id="stage" class="splashinputs" minlength="3"
                                                maxlength="100">
                                                <option></option>
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <select name="submission" id="submission" class="splashinputs" minlength="3"
                                                maxlength="100">
                                                <option></option>
                                                <option>Yes</option>
                                                <option>No</option>>
                                        ...
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <select name="Industry" id="Industry" class="splashinputs" minlength="3"
                                                maxlength="100">
                                                <option></option>
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="text" name="training" id="training" placeholder="Optional"
                                                class="splashinputs" minlength="3" maxlength="100">
                                        ...
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="text" name="institution" id="institution"
                                                placeholder="Optional" class="splashinputs" minlength="3"
                                                maxlength="100">
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-6 col-sm-12">
                                            ...
                                            <input type="password" name="passwordw1" id="passwordw1"
                                                class="splashinputs" minlength="3" maxlength="100">

                                        </div>
                                        <div class="col-sm-6 col-sm-12">
                                            Repeat-Password:<span class="required">*</span>
                                            <input type="password" name="passwordw2" id="passwordw2"
                                                class="splashinputs" minlength="3" maxlength="100">
                                    ...
                                    <div class="row" style="margin-top:3px">
                                        <div class="col-sm-12 col-sm-12">
                                            ...
                                            <label
                                                style="font-weight: initial !important; color: #000;opacity: 1 !important;"
                                                class="submit_radiosd">
                                                <div class="col-sm-1 col-xs-1">
                                                    <input type="checkbox" checked="true" style="opacity: 1 !important;"
                                                        id="termsbs" value="termsbs" name="termsbs" class="pancityd"
                                                        role="termsbs">
                                    ...
                                    <span class="btn btn-block btn-primary" name="SubmitButton" id="Submitelerning">Sign
                                        Up</span>


                                    <div class="col-sm-12 col-xs-12" id="errorreport"
                        ...
                        <div class="card-footer text-center">
                            <div>Already have an account? Please <a style="cursor:pointer;"
                                    onclick='$("#back_tologin").click()' id=""> Log In</a></div>
            ...
            if (busername && bpass) {
                ...
                $.post("login/login.php", { busername: busername, bpass: bpass }, function (responce) {
                    ...
                    if (recoversource) {
                        ...
                        } else if ($.trim(ddata) == "Your account does not exist, kindly sign up") {
                            $("#error_data").html(ddata);
