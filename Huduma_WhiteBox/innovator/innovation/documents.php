...
<div class="col-sm-12 col-xs-12"><span style="float:right;" class="btn btn-danger closedocuments" >Close</span></div>
...
$('html, body').animate({scrollTop: '0px'}, 300);
  $(".dashboard_holder").hide();
      ...
      }else{$("#dock_display").html("").hide();
        $("#summary").show();
      }
            /*
   var innovation=btoa('<?php echo $innovation?>');
   var page='<?php echo $page?>';
var url="modules/system/clerk/pages/"+page+"/full_statement.php";
