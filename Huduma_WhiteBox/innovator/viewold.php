...
?>
<div class="col-md-12" style="padding-left: 5% !important;padding-right: 5% !important;">

                                      <table class="table table-responsive table-striped col-md-12 table-bordered" width="">
                                        <thead>
                                          <tr><th>Field Name</th><th>Your description <span id="close_btns" style="float:right;color:#fff !important;background-color: red !important;" class="btn theme_bg">Close <i class="fa fa-close"></i></span></th></tr></thead>
