...
color: #6a8d96;
    ...
    <!--section ends-->
    <section class="content col-md-12 no_padding paddingleft_right15">
        <div class="row no_padding">
            <div class="col-md-12 no_padding">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="plus" data-size="16" data-loop="true" data-c="#fff" data-hc="white" id="livicon-11" style="width: 16px; height: 16px;"></i> Submit an Innovation
                        </h3>
                    </div>
                        ...
                        <form id="commentForm" action="" method="POST" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate">
                            ...
                            <div id="rootwizard">
                                <ul class="nav nav-pills">
                                    <li class="bv-tab-error">
                                        <a href="#tab1" data-toggle="tab" class="tabs" id="tabs1" class="active show">1. Terms and Conditions</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group col-sm-12 col-lg-12">
                                                <label for="Solution">Describe the problem you have identified.</label>
                                            ...
                                            <small style="display: none;" class="help-block" data-bv-validator="notEmpty" data-bv-for="ProblemSolution" data-bv-result="NOT_VALIDATED">This field is required</small><small style="display: none;" class="help-block" data-bv-validator="stringLength" data-bv-for="ProblemSolution" data-bv-result="NOT_VALIDATED">Please enter a value with valid length</small></div>
                                              <!-- solution Field -->
                                            <div class="form-group col-sm-12 col-lg-12">
                                                <label for="Solution">What solution are you providing to the problem.</label>
                                                <span style="color: red;">*</span> <i>(Maximum
                                                    600 characters)</i>
                                         ...
                                         <div class="form-group col-sm-12 col-lg-12">
                                            ...
                                            <div class="form-group <?php echo $shownumbers?>?> col-sm-12 col-lg-12" id="partners_number">
                                             ...
                                             <select id="number_partners" class="form-control " name="number_partners">
                                                ...
                                                <option class="<?php echo $shownumbers?>"></option>
                                                <?php for($i=0;$i<=5;$i++){
                                                    ?>
...
?>
                                           ...
                                           <div class="form-group col-sm-12 col-lg-12">
                                               ...
                                               <select id="protection" class="form-control ">
                                  ...
                                  $sqlx="SELECT * FROM innovators_partners where Innovation_Id='$Innovation_Id'";
                                   ...
                                   ?>
                                    ...
                                    <ul class="pager wizard col-sm-8">
                                        ...
                                        <li class="next finish innov_buttons hidden" id="innov_submit_button">
...
$("#innov_submit_button").removeClass("hidden");
            }else{
...
$("#innov_submit_button").addClass("hidden").hide();
 ...
 $.get("Huduma_WhiteBox/innovator/innovation/page.php",function(data){
 var datad=atob(data);
if(datad=="success"){

           $("#submision_error").html(datad+"...redirecting.."+loader).css("color","#000");  

            $.get("Huduma_WhiteBox/innovator/innovations.php",function(data){
                $("#home_display").html(data).show();
                $('html, body').animate({scrollTop: '0px'}, 300);
            })
        }else{
