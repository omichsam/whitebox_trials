...
<section class="content paddingleft_right15">
    ...
    <tr role="row">
      ...
      <th class="sorting" tabindex="0" aria-controls="innovations-table" rowspan="1" colspan="1" style="width: 102px;" aria-label="Evaluation Status: activate to sort column ascending">Submitted</th>
     <th class="sorting" tabindex="0" aria-controls="innovations-table" rowspan="1" colspan="1" style="width: 103px;" >Current stage</th>
      <th class="sorting" tabindex="0" aria-controls="innovations-table" rowspan="1" colspan="1" style="width: 136px;" aria-label="Action: activate to sort column ascending">View</th><th class="sorting" tabindex="0" aria-controls="innovations-table" rowspan="1" colspan="1" style="width: 103px;" aria-label="Date Submitted: activate to sort column ascending">Track innovation</th><th class="sorting" tabindex="0" aria-controls="innovations-table" rowspan="1" colspan="1" style="width: 103px;" aria-label="Date Submitted: activate to sort column ascending">Feedback</th>
...
//$stagename=$Evaluation_status;

$Status=$Evaluation_status;

  
  if($Status=="waiting"){
$stagename='Pending at First Evaluation';
...
$button_check="hidden";
  ...
  if($counter % 2 != 0){ 
    ...
    <tr role="row" class="odd">
           ...
           <td><a class=""  id="<?php echo $Innovation_Id?>" style="">
                        <?php echo $stagename." stage"?>
                    </a>
